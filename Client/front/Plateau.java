...
public class Plateau extends JPanel {
    ...
    Window window;
    Color myColor = new Color(0, 30, 255);
    Color enemyColor = new Color(174, 177, 177);
    ...
    public void setUpPlayer() {
        // Données de test
        this.me = new Player("AINA");
        this.me.setColor(myColor);
        this.enemy = new Player("FITAHIANA");
    ...
    public void paint(Graphics gg) {
        ...
        if (showLineWinner) {
            ...
            g.drawLine((int) firstPostePos.getxPos(), (int) firstPostePos.getyPos(), (int) lastPostePos.getxPos(),
                    (int) lastPostePos.getyPos());
        }
        repaintAllPoste();
    }
    ...
    public void drawPlateau(Graphics2D g) {
        ...
        // horizontale
        g.drawLine((int) 30, (int) 20, (int) (this.getWidth() - 10), (int) 20);
        g.drawLine((int) 30, (int) 150, (int) (this.getWidth() - 10), (int) 150);
        g.drawLine((int) 30, (int) (this.getHeight() - 200), (int) (this.getWidth() - 10),
                (int) (this.getHeight() - 200));
        g.drawLine((int) 30, (int) (this.getHeight() - 65), (int) (this.getWidth() - 10),
                (int) (this.getHeight() - 65));
        // verticale
        g.drawLine((int) 30, (int) 20, (int) 30, (int) (this.getHeight() - 65));
        g.drawLine((int) 170, (int) 20, (int) 170, (int) (this.getHeight() - 65));
        g.drawLine((int) (this.getWidth() - 170), (int) 20, (int) (this.getWidth() - 170),
                (int) (this.getHeight() - 65));
        g.drawLine((int) (this.getWidth() - 10), (int) 20, (int) (this.getWidth() - 10), (int) (this.getHeight() - 65));
    }
    ...
    public boolean verifyWinner() {
        ...
        for (int i = 0; i < postes.size(); i++) {
            if (postes.get(i).getMyMaster() == null) {
                continue;
            }
            // verticale
            if (i == 0 || i == 1 || i == 2) {
                if (postes.get(i + 3).getMyMaster() != null && postes.get(i + 6).getMyMaster() != null) {
                    if (postes.get(i + 3).getMyMaster().equals(postes.get(i).getMyMaster())
                            && postes.get(i + 6).getMyMaster().equals(postes.get(i).getMyMaster())) {
            ...
            if (i == 0 || i == 3 || i == 6) {
                if (postes.get(i + 1).getMyMaster() != null && postes.get(i + 2).getMyMaster() != null) {
                    if (postes.get(i + 1).getMyMaster().equals(postes.get(i).getMyMaster())
                            && postes.get(i + 2).getMyMaster().equals(postes.get(i).getMyMaster())) {
                        winner = postes.get(i).getMyMaster();
            ...
            if (i == 0) {
                ...
                if (postes.get(i + 4).getMyMaster() != null && postes.get(i + 8).getMyMaster() != null) {
                    if (postes.get(i + 4).getMyMaster().equals(postes.get(i).getMyMaster())
                            && postes.get(i + 8).getMyMaster().equals(postes.get(i).getMyMaster())) {
                        winner = postes.get(i).getMyMaster();
            ...
            if (i == 2) {
                if (postes.get(i + 2).getMyMaster() != null && postes.get(i + 4).getMyMaster() != null) {
                    if (postes.get(i + 2).getMyMaster().equals(postes.get(i).getMyMaster())
                            && postes.get(i + 4).getMyMaster().equals(postes.get(i).getMyMaster())) {
                        winner = postes.get(i).getMyMaster();
